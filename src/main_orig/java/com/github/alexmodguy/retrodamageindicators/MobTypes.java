...
public enum MobTypes {
    ...
    MobTypes() {
        texture = new ResourceLocation(
            "retrodamageindicators:textures/gui/mob_types/" + name().toLowerCase(Locale.ROOT) + ".png");
    }
    ...
    public static MobTypes getTypeFor(Entity entity) {
        ...
        if (entity instanceof LivingEntity living) {
            ...
            if (living.getMobType() == MobType.WATER) {
                ...
                return living instanceof WaterAnimal || living.canBreatheUnderwater() ? WATER_ARTHROPOD
                    : living instanceof Enemy ? ARTHROPOD_MONSTER : ARTHROPOD;
