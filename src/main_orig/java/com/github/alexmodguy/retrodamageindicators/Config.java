...
public class Config {
    ...
    public Config(final ForgeConfigSpec.Builder builder) {
        ...
        hudEntitySize = builder.comment("The size in pixels a usual entiud-ity should render as in the hud indicator.").translation("hud_entity_size").defineInRange("hud_entity_size", 38.0D, 0.0D, 2000.0D);
